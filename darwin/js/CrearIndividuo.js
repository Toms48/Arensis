...
La suma de las variables tamano, velocidad, vida y descendencia es igual a 100.
*/
function crearIndividuo(listado, matriz , padre, madre){
	...
	//Actualiza el listado
	document.getElementById(listado).innerHTML += "<b>Individuo "+matriz.indice+"</b><br>"+
